...
public class Constants {
    ...
    public static final int FRONT_LEFT_MODULE_STATUS_PERIOD = 255;
    public static final int FRONT_LEFT_MODULE_ENCODER_UPDATE_PERIOD = 100;
    ...
    public static final int FRONT_RIGHT_MODULE_STATUS_PERIOD = 254;
    public static final int FRONT_RIGHT_MODULE_ENCODER_UPDATE_PERIOD = 100;
    ...
    public static final int BACK_LEFT_MODULE_STATUS_PERIOD = 253;
    public static final int BACK_LEFT_MODULE_ENCODER_UPDATE_PERIOD = 100;

    public static final int BACK_RIGHT_MODULE_DRIVE_MOTOR = 6;
    public static final int BACK_RIGHT_MODULE_STEER_MOTOR = 5;
    public static final int BACK_RIGHT_MODULE_STEER_ENCODER = 3;
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(261.71);
    public static final int BACK_RIGHT_MODULE_STATUS_PERIOD = 252;
    public static final int BACK_RIGHT_MODULE_ENCODER_UPDATE_PERIOD = 100;
}
